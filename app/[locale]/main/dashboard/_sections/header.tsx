...
export default function Header() {
    ...
    return (
        <>
            <div className={`flex items-center ${onDetailsPage && `justify-between`} w-full px-[153px] py-8 border-b-[2px] border-[#D4D4D4]`}>
                <div className="text-gray-700 text-[30px]"> {onDetailsPage ? translate('order') : section} </div>
                {onDetailsPage &&
                    (
