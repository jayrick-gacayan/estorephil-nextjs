            ...
            <div className="flex items-center justify-center p-4 w-[884px] m-auto">
                ...
                <div className="w-[25%]">
                    <div className="flex relative">
                        ...
                        <div className={`flex items-center justify-center rounded-full w-[50px] h-[50px] z-10 px-4 py-2 text-center ${url.includes('payment-method') ? `bg-[#f3f3f3] text-black` : `bg-blue-500 text-white`} text-[20px]`}>4</div>
