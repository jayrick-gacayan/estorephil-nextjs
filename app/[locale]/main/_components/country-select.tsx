                ...
                <div className="relative py-2">
                    ...
                    <div className="py-2">
                        <select
                            ...
                            value={value}
                            className={`${!!paddingHeight ? `py-[${paddingHeight}px]` : `py-[4px]`} ${!!paddingWidth ? `py-[${paddingWidth}px]` : `px-[2px]`} border-[1.5px] border-gray-200 rounded-sm outline-blue-500 w-full `}
                            onChange={onChange}
                        >
