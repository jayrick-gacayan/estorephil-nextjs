...
export default function CartDropdownItem(props: any & { onDelete: () => void }) {
  return (
    <div className='flex gap-2 items-center p-2 border-b border-b-secondary-light justify-between w-full'>
      <div className='relative flex-none w-12 h-12 rounded overflow-hidden'>
        <Image alt={`shop-method-name-${props.name}-${props.id}`} src={props.image_url ?? `https://www.odnetwork.org/global_graphics/default-store-350x350.jpg`} fill className='object-cover' />
      </div>
