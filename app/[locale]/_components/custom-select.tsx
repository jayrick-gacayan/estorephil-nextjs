        ...
        <div className="block relative">
          <div
            ...
            <div className="w-auto flex-none">
              <HiChevronDown
                className={`transition-all duration-100 w-min  h-min ${
          ...
          <div
            className={`overflow-auto rounded border border-tertiary-dark absolute top-[110%] z-50 w-full text-default-dark left-0  ${
                ...
                <div
                  ...
                  className={`px-2 py-1 cursor-pointer ${
                    currentValue === itemValue && currentValue !== ""
                      ...
                      : `bg-inherit ${hoverColor} hover:text-white`
                  }`}
                  onClick={() => {
                    setVisible(false);
