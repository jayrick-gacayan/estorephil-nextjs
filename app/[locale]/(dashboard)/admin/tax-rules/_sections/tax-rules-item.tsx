          ...
          <table className={`w-full `}>
            <thead>
              <tr className="text-gray-600 border-t-2 border-b-2 bg-white text-left text-sm">
                ...
                <th className="px-4 py-2 whitespace-nowrap">Tax Description</th>
                ...
                <th className="px-4 py-2 whitespace-nowrap">Seller Country</th>
                <th className="px-4 py-2 whitespace-nowrap">Seller Province</th>
                <th className="px-4 py-2 whitespace-nowrap">
                  Destination Country
                </th>
                <th className="px-4 py-2 whitespace-nowrap">
              ...
              {orders.map((order) => {
                return (
                  <tr
                    ...
                    <td className={`${rowHeight}`}>{order.productCategory}</td>
                    ...
                    <td className={`${rowHeight}`}>{order.thresholdAmount}</td>
                    <td className={`${rowHeight}`}>
