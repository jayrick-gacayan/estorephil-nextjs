...
export default function DeliveryAreas() {
  ...
  return (
    <DeliveryAreasContainer labelText="Delivery Areas">
      <div className="flex items-center w-full">
        ...
        <div className="relative w-full">
          ...
          <div className="overflow-auto w-full z-10 bg-white transition-all delay-100 absolute peer-focus/region:h-[240px] h-0 rounded peer-focus/region:border-[.5px] border-0 border-tertiary-dark top-[110%]">
            {
