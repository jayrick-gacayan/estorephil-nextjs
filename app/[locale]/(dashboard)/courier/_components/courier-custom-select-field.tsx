  ...
  return (
    <div className="bg-white w-full relative">
      <div className="relative bg-inherit [&_div.items-container]:focus-within:block">
        <div className="flex items-center  border-[.5px] [&_.chevron-down]:focus-within:-rotate-90 focus-within:border-info border-[#707070] rounded px-2 ">
          <div className="flex-1">
            <input type="text"
              id={inputId}
              readOnly
              value={currentValue}
              className="relative z-0 peer sample p-2 w-full text-[#707070] outline-0 outline-none" placeholder='' />
          </div>
        ...
        <div className={`items-container transition-all hidden z-20 delay-100 overflow-auto rounded border border-[#707070] absolute top-[110%] w-full bg-white left-0 ${items.length > 5 ? 'peer-focus/sample:h-56 peer-focus/sample:border' : 'peer-focus/sample:h-fit peer-focus/sample:border'}`}>
          {
