...
export default function DashboardMenuItemLink(props: MenuProps &
{
  ...
  return (
    <Link href={props.link!}
      className={`transition-all delay-100 ${props.alt === 'delivery-rates' ? 'cursor-not-allowed text-secondary-light' : `${props.onActiveMenu(props.alt, props.segment)} hover:bg-tertiary-light hover:text-primary`} px-4 py-2  w-full h-fit flex items-center gap-2`}
