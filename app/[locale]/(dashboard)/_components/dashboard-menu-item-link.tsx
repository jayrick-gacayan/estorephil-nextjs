...
export default function DashboardMenuItemLink(props: MenuProps &
{
  ...
  return (
    <Link href={props.link!}
      className={`${props.alt === 'delivery-rates' ? 'cursor-not-allowed text-secondary-light' : `${props.onActiveMenu(props.alt, props.segment)} hover:bg-tertiary-light hover:text-[#32BCE6]`} px-4 py-2  w-full h-fit flex items-center gap-2`}
