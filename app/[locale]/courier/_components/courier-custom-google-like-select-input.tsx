    ...
    <div className="bg-white w-full relative">
      <div className="relative bg-inherit">
        ...
        <label htmlFor={inputId}
          className={`absolute cursor-text transition-all left-0 -top-3 text-sm text-[#707070] ${currentValue === '' ? 'bg-transparent px-1 mx-2 peer-focus:bg-inherit' : 'bg-inherit mx-2 px-1'}  
        ...
        <div className={`transition-all delay-100 overflow-auto rounded border-0 border-[#707070] absolute top-[110%] w-full bg-white left-0 ${items.length > 5 ? 'peer-focus:h-56 peer-focus:border' : 'peer-focus:h-auto peer-focus:border'} peer-focus:block hidden`}>
          {
